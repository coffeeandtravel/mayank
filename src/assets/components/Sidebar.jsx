...
// const Sidebar = () => {
//     return (
//       <div className="flex-1 lg:flex-col justify-between min-h-screen lg:sticky top-0 lg:max-h-screen p-5 lg:p-10">
//         <div className="mt-5 lg:mt-20">
//           <header>
//             <a href="#" className="w-max">
//               <h1 className="text-4xl lg:text-8xl heading my-3">Mayank Gaur</h1>
//             </a>
//             <p className="text-xs lg:font-semibold">Artificial Intelligence and Data Science Engineer</p>
//           </header>
//         </div>
...
//         <div className="flex flex-row justify-center gap-5 items-center mt-10 lg:mt-20">
